...
// Este es un controlador REST que maneja las solicitudes relacionadas con la educación. 
// Está etiquetado con @RestController y la URL base para todas las solicitudes es /educacion. 
// También permite solicitudes de origen cruzado desde http://localhost:4200.
@RestController
...
public class CEducacion {
	...
	// para inyectar la dependencia de la clase "Seducacion" en la clase actual.
	@Autowired
	...
	// Detalle de una educacion por id
